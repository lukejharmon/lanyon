...
![Figure 12.1. Contrasts in frog diversity. Spotted frogs (A) and Pacific tree frogs (B) come from diverse clades, while tailed frogs (C) and New Zealand frogs (D) are from depauperate clades. Photo credits: A: Sean Neilsen / [Wikimedia Commons](http://commons.wikimedia.org/) / Public Domain, B: User:The High Fin Sperm Whale / [Wikimedia Commons](http://commons.wikimedia.org/) / [CC-BY-SA-3.0](https://creativecommons.org/licenses/by-sa/3.0/deed.en), C:  User:Leone.baraldi / [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Rana_con_la_coda_4.jpg) / [CC-BY-SA-4.0](https://creativecommons.org/licenses/by-sa/3.0/deed.en), D: Phil Bishop / [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Leiopelma_pakeka01.jpg) / [CC-BY-SA-2.5](https://creativecommons.org/licenses/by-sa/2.5/deed.en).]({{ site.baseurl }}/images/figure12-1.png)
...
![Figure 12.2. A phylogenetic tree including three clades, illustrating two possible models for diversification: a constant rates model, where all three clades have the same diversification parameters $\lambda_T$ and $\mu_T$, and a variable rates model, where clade A has parameters ($\lambda_A$ and $\mu_A$) that differ from those of the other two clades ($\lambda_B$ and $\mu_B$). Image by the author, can be reused under a [CC-BY-4.0](https://creativecommons.org/licenses/by/4.0/) license.]({{ site.baseurl }}/images/figure12-2.png)
...
![Figure 12.3. Phylogenetic tree of amphibians with divergence times and diversities of major clades. Data from Jetz and Pyron [@Jetz2018-mh]. Image by the author, can be reused under a [CC-BY-4.0](https://creativecommons.org/licenses/by/4.0/) license.]({{ site.baseurl }}/images/figure12-3.png)
...
![Figure 12.6. Lineage-through-time plots under a protracted birth-death model. Redrawn from Etienne and Rosindell [-@Etienne2012-uh]. Image by the author, can be reused under a [CC-BY-4.0](https://creativecommons.org/licenses/by/4.0/) license.]({{ site.baseurl }}/images/figure12-6.png)
